...
\item \textbf{The \leadershipbody{} Will Manage the
  ...
  NumFOCUS' Board of Directors. NumFOCUS will only intervene in the program
...
\item \textbf{Fees}. The \signatories{} agree to donate ten percent (10\%) of
  ...
  income and donations) to NumFOCUS for its general operations.
...
\item \textbf{Project Fund/Variance Power}. Beginning on the Effective Date,
  ...
  sole judgment.  NumFOCUS agrees to make a good faith effort to consider any
