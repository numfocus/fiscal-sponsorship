...
\item \textbf{The \leadershipbody{} Will Manage the
  ...
  to the extent the Project in not in compliance with \ref{OpenSourceSoftware}
...
\item \textbf{Ultimate Responsibility of Project}. Subject to
  ...
  information work, fundraising events, and other activities planned by the
  Project, shall be the ultimate responsibility of the project. NumFOCUS may
  provide assistance with such events if requested by the project, and will
  consider each request on a case-by-case basis.  \fix{We still need to decide
    precisely what language to use regarding: \emph{``processing and acknowledgment of
    cash and non-cash revenue items, accounts payable and receivable,
    negotiation of leases and contracts, disbursement of Project funds
    (including grants)'' }}
